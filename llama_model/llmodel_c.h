 ...
 */
typedef bool (*llmodel_prompt_callback)(int32_t token_id, int lsz, int esz, float *logits, float *embds);
 ...
 */
typedef bool (*llmodel_response_callback)(int32_t token_id, const char *response, int lsz, int esz, float *logits, float *embds);
